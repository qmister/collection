...
use ArrayIterator;
use stdClass;
use tp5er\Traits\EnumeratesValues;
...
class Collection implements ArrayAccess, Enumerable
{
    ...
    {
        if (strpos($key, '.') !== false) {
            return Arr::dataGet($this->all(), $key, $default);
        }
    ...
    public function getOrPut($key, $value)
    {
        ...
        $this->offsetSet($key, $value = Values::value($value));
        return $value;
    }
     ...
     * @return HigherOrderCollectionProxy|static
     */
